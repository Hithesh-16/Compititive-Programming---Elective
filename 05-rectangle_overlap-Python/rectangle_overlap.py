...
def fun_rectangle_overlap(left1, top1, width1, height1, left2, top2, width2, height2):
    fact1=((left2>left1)and(left2>left1+width1))
    fact2=((left1>left2)and(left1>left2+width2))
    fact3=((top2>top1)and(top2>top1+height1))
    fact4=((top1>top2)and(top1>top2+height2))
    if(fact1 or fact2 or fact3 or fact4):
        return False
    else:
        return True
